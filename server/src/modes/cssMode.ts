...
import { WMLDocumentRegions, CSS_STYLE_RULE } from './embeddedSupport';

export function getCSSMode(documentRegions: LanguageModelCache<WMLDocumentRegions>): LanguageMode {
