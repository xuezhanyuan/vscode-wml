...
import { TextDocument, Position, LanguageService, TokenType, Range } from 'vscode-wml-languageservice';
...
export interface WMLDocumentRegions {
...
export function getDocumentRegions(languageService: LanguageService, document: TextDocument): WMLDocumentRegions {
