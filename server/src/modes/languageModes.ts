...
import { getLanguageService as getWMLLanguageService, DocumentContext } from 'vscode-wml-languageservice';
import {
...
import { getDocumentRegions, WMLDocumentRegions } from './embeddedSupport';
import { getCSSMode } from './cssMode';
import { getJavascriptMode } from './javascriptMode';
import { getWMLMode } from './wmlMode';
...
export function getLanguageModes(supportedLanguages: { [languageId: string]: boolean; }): LanguageModes {
	...
	var wmlLanguageService = getWMLLanguageService();
	let documentRegions = getLanguageModelCache<WMLDocumentRegions>(10, 60, document => getDocumentRegions(wmlLanguageService, document));

	let modelCaches: LanguageModelCache<any>[] = [];
	modelCaches.push(documentRegions);

	let modes = {};
	modes['wml'] = getWMLMode(wmlLanguageService);
