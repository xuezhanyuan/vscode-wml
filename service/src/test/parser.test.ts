...
import {Node, WMLDocument, parse} from '../parser/wmlParser';
...
suite('WML Parser', () => {
	...
	test('Simple', () => {
		assertDocument('<page></page>', [{ tag: 'page', start: 0, end: 13, endTagStart: 6, closed: true, children: [] }]);
		assertDocument('<page><data></data></page>', [{ tag: 'page', start: 0, end: 26, endTagStart: 19, closed: true, children: [{ tag: 'data', start: 6, end: 19, endTagStart: 12, closed: true, children: [] }] }]);
		assertDocument('<page><data></data><data></data></page>', [{ tag: 'page', start: 0, end: 39, endTagStart: 32, closed: true, children: [{ tag: 'data', start: 6, end: 19, endTagStart: 12, closed: true, children: [] }, { tag: 'data', start: 19, end: 32, endTagStart: 25, closed: true, children: [] }] }]);
	});
