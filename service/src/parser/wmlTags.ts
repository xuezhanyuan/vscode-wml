 ...
 *  from or derived from WML 5.1 W3C Working Draft (http://www.w3.org/TR/2015/WD-html51-20151008/.)"
 *--------------------------------------------------------------------------------------------*/
/*---------------------------------------------------------------------------------------------
...
export interface IWMLTagProvider {
	getId(): string;
	isApplicable(languageId: string);
	collectTags(collector: (tag: string, label?: string,pLable?:string) => void): void;
...
export interface ITagSet {
	[tag: string]: WMLTagSpecification;
}

export class WMLTagSpecification {
	constructor(public label: string, public attributes: string[] = [],public pLable?:string) { }
}
...
export const WML_TAGS: ITagSet = {
	// The root element
	'page': new WMLTagSpecification(localize('page', ''),
		['name', 'id']),
	// Sections
	'data': new WMLTagSpecification(localize('tags.data', 'The ionContent directive provides an easy to use content area that can be configured to use Ionic\'s custom Scroll View, or the built-in overflow scrolling of the browser.'),
		['name','id','style'],'page'),
	'dataset': new WMLTagSpecification(localize('tags.dataset', 'Child of ionItem'),
		['name','id','style'],'page'),
	'Grid':new WMLTagSpecification(localize('tags.Grid', 'Child of ionItem'),
		['name','id','style'],'page'),
	'GridRow':new WMLTagSpecification(localize('tags.GridRow', 'Child of ionItem'),
		['name','id','style'],'Grid')
};
...
export const HTML_TAGS: ITagSet = {
	...
	// Sections
	article: new WMLTagSpecification(
	...
	section: new WMLTagSpecification(
	...
	footer: new WMLTagSpecification(
	...
	address: new WMLTagSpecification(
	...
	blockquote: new WMLTagSpecification(
	...
	figure: new WMLTagSpecification(
	...
	figcaption: new WMLTagSpecification(
	...
	embed: new WMLTagSpecification(
		localize('tags.embed', 'The embed element provides an integration point for an external (typically non-WML) application or interactive content.'),
		['src', 'type', 'width', 'height']),
	object: new WMLTagSpecification(
	...
	source: new WMLTagSpecification(
	...
	colgroup: new WMLTagSpecification(
	...
	button: new WMLTagSpecification(
	...
	select: new WMLTagSpecification(
	...
	datalist: new WMLTagSpecification(
	...
	textarea: new WMLTagSpecification(
	...
	output: new WMLTagSpecification(
	...
	fieldset: new WMLTagSpecification(
	...
	legend: new WMLTagSpecification(
	...
	details: new WMLTagSpecification(
		...
		['open:v']),
	summary: new WMLTagSpecification(
	...
	dialog: new WMLTagSpecification(
	...
	// Scripting
	script: new WMLTagSpecification(
	...
	noscript: new WMLTagSpecification(
	...
	template: new WMLTagSpecification(
		localize('tags.template', 'The template element is used to declare fragments of WML that can be cloned and inserted in the document by script.')),
	canvas: new WMLTagSpecification(
...
export function getWmlTagProvider(): IWMLTagProvider {
	...
	return {
		getId: () => 'wml',
		isApplicable: (languageId) => languageId === 'wml',
		collectTags: (collector: (tag: string, label: string,plable?:string) => void) => collectTagsDefault(collector, WML_TAGS),
		collectAttributes: (tag: string, collector: (attribute: string, type: string) => void) => {
			collectAttributesDefault(tag, collector, WML_TAGS, globalAttributes);
			if (tag) {
		...
		collectValues: (tag: string, attribute: string, collector: (value: string) => void) => collectValuesDefault(tag, attribute, collector, WML_TAGS, globalAttributes, valueSets, customTags)
	};
}


export function getHTMLTagProvider(): IWMLTagProvider {
...
function collectTagsDefault(collector: (tag: string, label: string,plable?:string) => void, tagSet: ITagSet): void {
	for (var tag in tagSet) {
		collector(tag, tagSet[tag].label,tagSet[tag].pLable);
	}
}
